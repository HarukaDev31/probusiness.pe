$(function () {
	...
	$("#btn-contact").click(function (e) {
		...
		var nombres = $("#firstname"),
			lastname = $("#lastname"),
			celular = $("#celular"),
			email = $("#email");
			emailForm = $("#emailform");
		console.log(nombres.val().length);
		console.log(lastname.val().length);
		console.log(celular.val().length);
