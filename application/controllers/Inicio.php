...
class Inicio extends CI_Controller {
	...
	public function sendwhatsapp(){
		...
		if(isset($_POST['Nu_Agente_Compra']))
			$message_whastapp .= ' de Agente de Compra';
		if(isset($_POST['Nu_Carga_Consolidada']))
			$message_whastapp .= ' de Carga Consolidada';
		if(isset($_POST['Nu_Importacion_Grupal']))
			$message_whastapp .= ' de Importación Grupal';
		if(isset($_POST['Nu_Curso']))
			$message_whastapp .= ' de Curso';
		if(isset($_POST['Nu_Viaje_Negocios']))
		...
		//reemplazar correo de destino de mensajes
		...
		$data = array(
			...
			'Nu_Estado' => 1,
			'Nu_Agente_Compra' => (isset($_POST['Nu_Agente_Compra']) ? 1 : 0),
			'Nu_Carga_Consolidada' => (isset($_POST['Nu_Carga_Consolidada']) ? 1 : 0),
			'Nu_Importacion_Grupal' => (isset($_POST['Nu_Importacion_Grupal']) ? 1 : 0),
			'Nu_Curso' => (isset($_POST['Nu_Curso']) ? 1 : 0),
			'Nu_Viaje_Negocios' => (isset($_POST['Nu_Viaje_Negocios']) ? 1 : 0),
		);
		...
		echo json_encode($this->InicioModel->insertPosibleCliente($data, $message_whastapp));
